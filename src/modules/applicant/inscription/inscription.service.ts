...
export class InscriptionService {
    ...
    try {
      ...
      if (inscription) {
        throw new BadRequestException(
          'Ya has solicitado un registro de inscripccion',
        );
      }
      ...
      return {message: `La solicitud de inscripccion fue creada exitosamente`}
    } catch (error) {
      if (
  ...
  async updatePaymentMethod(
    ...
    try {
      ...
      return {message: `El método de pago fue actualizado exitosamente`}
    } catch (error) {
  ...
  async updateChangePaymentStatus(user: applicant) {
    try {
      ...
      if (payment_status === true) {
        ...
        return {message: `El Status de pago fue actualizado exitosamente`}
      } else {
